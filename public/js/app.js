                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'button',
                                { type: 'button', className: 'navbar-toggle collapsed', 'data-toggle': 'collapse', 'data-target': '#app-navbar-collapse', 'aria-expanded': 'false' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'span',
                                    { className: 'sr-only' },
                                    'Toggle Navigation'
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_CreateUser__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_EditUser__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_UserList__ = __webpack_require__(100);
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', className: 'form-control', id: 'name', placeholder: 'Name',
                            value: this.state.name, onChange: this.handleChangeName, required: true })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { className: 'form-group' },
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'email', className: 'form-control', id: 'email', placeholder: 'Email',
                            value: this.state.email, onChange: this.handleChangeEmail, required: true })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { className: 'form-group' },
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'password', className: 'form-control', id: 'password', placeholder: 'Password',
                            value: this.state.password, onChange: this.handleChangePassword, required: true })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'button',
...
var EditUser = function (_Component) {
    ...
    _createClass(EditUser, [{
        ...
        value: function componentDidMount() {
            ...
            var url = window.Laravel.baseUrl + '/api/users/' + this.props.match.params.id + '/edit';
        ...
        value: function handleSubmit(e) {
            ...
            e.preventDefault();
            var url = window.Laravel.baseUrl + '/api/users/' + this.props.match.params.id;
            var data = {
                name: this.state.name,
                email: this.state.email,
                password: this.state.password
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.patch(url, data).then(function (response) {
                _this3.props.history.push('/users');
            }).catch(function (error) {
                console.log(error);
            });
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__UserRow__ = __webpack_require__(101);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var UserList = function (_Component) {
    ...
    _createClass(UserList, [{
        ...
        value: function componentDidMount() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(window.Laravel.baseUrl + '/api/users').then(function (response) {
        ...
        value: function fetchRows() {
            ...
            if (this.state.users instanceof Array) {
                return this.state.users.map(function (object, i) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__UserRow__["a" /* default */], { obj: object, key: i, index: i, deleteRow: _this3.deleteRow.bind(_this3) });
                });
            }
        }
    }, {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        { className: 'btn btn-success pull-right', to: '/users/create' },
                        'Add User'
                    )
                ),
...
var UserRow = function (_Component) {
    ...
    _createClass(UserRow, [{
        ...
        value: function handleDelete(e) {
            ...
            var url = window.Laravel.baseUrl + '/api/users/' + this.props.obj.id;
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.delete(url).then(function (response) {
                _this2.props.deleteRow(_this2.props.index);
            }).catch(function (error) {
                console.log(error);
            });
        }
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["a" /* Link */],
                        { className: 'btn btn-primary', to: '/users/edit/' + this.props.obj.id },
                        'Edit'
                    )
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
/* harmony default export */ __webpack_exports__["a"] = (UserRow);
